...
class GitLabSrcClient:
    ...
    async def get_repo_config(self):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            # TODO does this need to be changed to something more generic than .github?
            # TODO document that the config is searched for in the HEAD of the repo's default branch
